  ...
  if(!Yii::$app->user->isGuest){
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Kasus', 'visible' => Yii::$app->user->getIdentity()->level==1 || Yii::$app->user->getIdentity()->level==2 || Yii::$app->user->getIdentity()->level==4 || Yii::$app->user->getIdentity()->level==5 || Yii::$app->user->getIdentity()->level==6, 
                    'items' => [
                        ['label' => 'Daftar Kasus','url' => ['/kasus/index']],
                        ['label' => 'Pencarian Kasus','url' => ['/kasus/search']],
                ],
                ],
